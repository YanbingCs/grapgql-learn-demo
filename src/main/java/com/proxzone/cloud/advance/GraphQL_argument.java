...
public class GraphQL_argument {
    public static void main(String[] args) {
        ...
        user.setName("myb");
        user.setSex("男");
        user.setIntro("cloud-platform,GraphQL learn");
        users.add(user);
        ...
        //添加用户列表
        result = graphQL.execute("mutation{addUserByInput(userInfo:{name:\"test2\",sex:\"男\",intro:\"GraphQL 学习\",skills:[\"Spark\",\"Docker\"]}){name　sex　intro}}").getData();
        System.out.println(result);
    }
